...
public class OcrDemo {
    ...
    public static void main(String[] args) {
        ...
        String appId = "1257998505";
        String secretId = "AKIDmNktmQ4CE0WmnZLLM7crtiIenjRua7rM";
        String secretKey = "PabOxINL35tRjlX3JJ46vUdYDclfJisp";
        String bucketName = "1257998505";
...
//        imagePorn(imageClient, bucketName);
    ...
    private static void ocrGeneral(ImageClient imageClient, String bucketName) {
        ...
        //2. 图片内容方式
        System.out.println("====================================================");
        request = new GeneralOcrRequest(bucketName, new File("assets", "1.png"));
        try {
            ret = imageClient.generalOcr(request);
        } catch (AbstractImageException e) {
            e.printStackTrace();
